...
if (!isset($_SESSION['idUsuario']) || !isset($_SESSION['nombreCompleto']) || $_SESSION['perfilNombre'] !== 'user') {
      ...
      <div class="sidebar-footer">
        <a href="##" class="sidebar-user">
          ...
          <div class="sidebar-user-info">
            ...
            <span class="sidebar-user__subtitle">Usuario</span>
          </div>
        </a>
      </div>
    </aside>
      ...
      <footer class="footer">
        <div class="container footer--flex">
          <div class="footer-start">
            <p><?php echo date('Y'); ?> © Elegant Dashboard</p>
          </div>
          <ul class="footer-end">

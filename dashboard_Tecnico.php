...
if (!isset($_SESSION['idUsuario']) || !isset($_SESSION['nombreCompleto']) || $_SESSION['perfilNombre'] !== 'tecnico') {
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link" href="facturacion/index.php">Facturacion generar factura</a>
  ...
  <div class="row mt-4">
    <div class="col-md-12">
      <h1 class="text-center">Sistema facturacion </h1>
    </div>
  </div>
  <div class="row mt-4">
    <?php
